...
let TelegramToken = '1897893294:AAEyIsnPGJBoxrWvG3yWFYbrrrLqDT9T5v8';
let TelegramCheckUseronlineToken = '1829466457:AAFWMay6CwvZSN59SU8cwl16NZNDw3zLP2I';
let TelegramCheckCuocToken = '1872636937:AAHc5-x3zx0mVshr4AFNhF-y-BCiR8vqKyU';
let TelegramCheckNapRutToken = '1871257898:AAF1rVpPE2iYISMMjkiwHAxmJo5qmG8KzHU';
...
let TelegramCheckCuoc   = new Telegram(TelegramCheckCuocToken, {polling: true});
let TelegramCheckNapRut   = new Telegram(TelegramCheckNapRutToken, {polling: true});
let fs 			  = require('fs');
...
process.redT = redT;
global.numberFromIdTele = 1880033219; // coment...							  
redT.telegram = TelegramBot;
redT.telegramBotUseronline = TelegramBotUseronline;
redT.TelegramCheckCuoc = TelegramCheckCuoc;
redT.TelegramCheckNapRut = TelegramCheckNapRut;								
global['redT'] = redT;
global['userOnline'] = 0;
